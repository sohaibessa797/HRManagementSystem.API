...
namespace HRManagementSystem.API.Controllers
{
    ...
    public class SalaryController : ControllerBase
    {
        ...
        public IActionResult AddSalaryAdjustment([FromBody] CreateSalaryAdjustmentRequest request)
        {
            ...
            return Ok(new { message = "Salary adjustment added successfully." });
        }
        ...
        public IActionResult GenerateSalary([FromQuery] Guid employeeId, [FromQuery] int month, [FromQuery] int year)
        {
            ...
            if (existingSalary != null)
                return BadRequest("Salary already generated for this month.");
            ...
            return Ok(new GenerateSalaryResponse
            {
        ...
        public IActionResult GetSalaryDetails([FromQuery] Guid employeeId, [FromQuery] int month, [FromQuery] int year)
        {
            ...
            if (salary == null)
                return NotFound("Salary record not found for this month.");
        ...
        public IActionResult MarkSalaryAsPaid(Guid salaryId)
        {
            ...
            if (salary.IsPaid)
                return BadRequest("Salary is already marked as paid.");
            ...
            return Ok(new { message = "Salary marked as paid successfully." });
        }
        ...
        public IActionResult GetAllSalaries()
        {
            ...
            if (!salaries.Any())
                return NotFound("No salary records found.");
